...
class Transformer {
    ...
    const Schema = ${schema};\n
    // @ts-ignore
    export const ${(0, pascal_case_1.toPascalCase)(exportName)}ObjectSchema: z.ZodType<Prisma.${(0, pascal_case_1.toPascalCase)(name)}> = Schema;
    export const ${(0, pascal_case_1.toPascalCase)(exportName)}Object = Schema;\n`;
    }
